...
import { FiBookOpen, FiUsers, FiBarChart2, FiLogIn } from 'react-icons/fi'; 
...
export default function HomePage() {
  ...
  let loginAction: string | (() => void) = '/login'; 
  let loginButtonText = "Login Siswa/Guru";

  if (!loading && user) { 
    const userRole = user.role;
    loginAction = (userRole && dashboardPaths[userRole]) ? dashboardPaths[userRole] : '/dashboard'; 
    loginButtonText = "Masuk ke Dashboard";
  }
