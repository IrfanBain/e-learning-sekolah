...
import { ClassFormData, createClassAction } from '@/app/actions/classActions';
...
export default function CreateClassPage() {
  ...
  const handleBatal = () => { if (!loading) router.push('/list/classes'); };
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg mx-auto border border-gray-200"> 
        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-5">
          ...
          <div className="flex justify-end gap-4 pt-5 border-t mt-5">
            ...
            <button type="submit" disabled={loading || fetchLoading || teachers.length === 0}
