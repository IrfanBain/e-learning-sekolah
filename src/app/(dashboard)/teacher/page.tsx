        ...
        const fetchTeacherSchedule = async () => { 
            ...
            try {
                ...
                const combinedSchedules: CombinedSchedule[] = scheduleDocs.map(sch => {
                    ...
                    const kelasInfo = kelasMap.get(sch.kelas_ref?.id) || null; 
                    return {
                        id: sch.id,
                        hari: sch.hari,
...
const ScheduleCard = ({ schedule }: { schedule: CombinedSchedule }) => {
    const displayKelasNama = schedule.kelasInfo 
        ? `${schedule.kelasInfo.tingkat || ''} ${schedule.kelasInfo.nama}`.trim()
        : "Kelas?"; 
            ...
            <div className="flex">
                ...
                <div className="flex-1 p-4 sm:p-5 flex flex-col justify-center">
                    ...
                    <div className="flex items-center text-gray-600 mt-1">
                        ...
                        <span className="text-sm sm:text-base">{displayKelasNama}</span> 
                    </div>
                </div>
            </div>
        </div>
